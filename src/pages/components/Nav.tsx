...
export default function Nav() {
    ...
    return (
        <nav className="relative mx-8 mb-24 flex justify-between items-center pt-12 pb-6 font-medium md:mx-16 lg:mx-32">
            <svg className="absolute bottom-0 left-1/2 -translate-x-1/2" width='250' height={4} viewBox="0 0 250 4" xmlns="http://www.w3.org/2000/svg" fill="none">
            ...
            <div onClick={() => setToggled(prevToggle => !prevToggle)} className="space-y-1.5 cursor-pointer z-50">
                <motion.span animate={{rotateZ: toggled ? 40 : 0, y: toggled ? 8 : 0}} className="block h-0.5 w-8 bg-black"></motion.span>
            ...
            className="fixed bg-white bottom-0 left-0 w-full h-screen flex items-center justify-center z-40">
